...
<body>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                ...
                                <li><a href="blog.html">A propos</a></li>
                            ...
                            <div class="register-login-area">
                                <a href="signup.html" class="btn">Inscription/Login</a>
                                <!-- <a href="index-login.html" class="btn active">Inscription/Login</a> -->
                            </div>
    ...
    <!-- ##### Catagory ##### -->
    <div class="instructors-video d-flex align-items-center justify-content-center bg-img" style="background-image: url(img/bg-img/prof.jpg);">
